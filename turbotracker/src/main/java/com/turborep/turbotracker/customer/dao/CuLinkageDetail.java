 ...
 */
@Entity
@Table(name = "cuLinkageDetail", catalog = "")
public class CuLinkageDetail implements java.io.Serializable {
	...
	public CuLinkageDetail() {
	}

	public CuLinkageDetail(Integer cuInvoiceId, Integer cuReceiptId,
	...
	@Column(name = "cuLinkageDetailID", unique = true, nullable = false)
