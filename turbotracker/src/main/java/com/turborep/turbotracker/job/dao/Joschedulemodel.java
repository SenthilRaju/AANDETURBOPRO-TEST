...
/**
 * Joschedulemodel generated by hbm2java
 */
@Entity
@Table(name = "joScheduleModel", catalog = "")
public class Joschedulemodel implements java.io.Serializable {
	...
	public Joschedulemodel() {
	}

	public Joschedulemodel(Integer joSchedTempHeaderId, String modelNo,
			...
			String col18, String col19, String col20, Integer prMasterId,
			String webAddress) {
	...
	@Column(name = "joScheduleModelID", unique = true, nullable = false)
	...
	@Column(name = "WebAddress", length = 120)
