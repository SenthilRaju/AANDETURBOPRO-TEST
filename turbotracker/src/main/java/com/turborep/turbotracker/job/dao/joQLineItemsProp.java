...
@Entity
@Table(name = "joQLineItemsProp", catalog = "")
public class joQLineItemsProp {
	private Integer joQLineItemsPropId;
	...
	@Column(name = "joQLineItemsPropId")
	public Integer getJoQLineItemsPropId() {
		return joQLineItemsPropId;
	}
	public void setJoQLineItemsPropId(Integer joQLineItemsPropId) {
		this.joQLineItemsPropId = joQLineItemsPropId;
	}
	@Column(name = "joQuoteDetailID")
