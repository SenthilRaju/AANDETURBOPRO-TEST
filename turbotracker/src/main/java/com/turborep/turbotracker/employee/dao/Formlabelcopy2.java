...
/**
 * Formlabelcopy2 generated by hbm2java
 */
@Entity
@Table(name = "formlabelcopy2", catalog = "")
public class Formlabelcopy2 implements java.io.Serializable {
	...
	public Formlabelcopy2() {
	}

	public Formlabelcopy2(BigDecimal tempSort, Integer formNo, String section,
