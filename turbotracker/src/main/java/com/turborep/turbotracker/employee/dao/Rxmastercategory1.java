...
/**
 * Rxmastercategory1 generated by hbm2java
 */
@Entity
@Table(name = "rxMasterCategory1", catalog = "BacheCompany")
public class Rxmastercategory1 implements java.io.Serializable {

	private int rxMasterCategory1id;
	...
	public Rxmastercategory1() {
	}

	public Rxmastercategory1(int rxMasterCategory1id) {
		this.rxMasterCategory1id = rxMasterCategory1id;
	}

	public Rxmastercategory1(int rxMasterCategory1id, Integer cuAssignmentId0,
	...
	@Id
	@Column(name = "rxMasterCategory1ID", unique = true, nullable = false)
	public int getRxMasterCategory1id() {
		return this.rxMasterCategory1id;
	}

	public void setRxMasterCategory1id(int rxMasterCategory1id) {
		this.rxMasterCategory1id = rxMasterCategory1id;
	}
