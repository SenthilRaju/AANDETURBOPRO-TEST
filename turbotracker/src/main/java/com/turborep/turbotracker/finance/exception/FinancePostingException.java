...
public class FinancePostingException  extends Exception {
	private static final long serialVersionUID = 1L;
	
	private int itsErrorStatusCode;
	
	public FinancePostingException(String theMessage){
		super(theMessage);
		setItsErrorStatusCode(500);
	}
	
	public FinancePostingException(String theMessage, Throwable theThrowable){
