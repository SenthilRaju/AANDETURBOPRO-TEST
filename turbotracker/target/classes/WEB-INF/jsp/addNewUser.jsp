						...
						<fieldset  class= " ui-widget-content ui-corner-all" style="width: 520px;height: 180px;">
							...
							<table style="width: 520px;">
								...
								<tr>
									...
									<td align="right"><label style="vertical-align: middle;">Is Employee</label><input type="checkbox" name="isEmployee" id="isEmployee" style="vertical-align: middle;"></td>
				...
				success: function(data){
					...
					if(aExistingUser === ''){
						$.ajax({
							...
							data : userDetails,
							success: function(data){
								createtpusage('Company-Users','Save user','Info','Company-Users,Saving user,userName:'+userName);
