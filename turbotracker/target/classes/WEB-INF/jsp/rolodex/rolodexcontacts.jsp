...
<div id="engineerGeneral">
	<form id="engineerFromID">
	<table>
		<tr height="0px;"></tr>
		<tr>
			<td width="105px;" style="padding-bottom: 10px;"><label>Customer Name: </label></td>
			...
			<td align="right">
				<input type="button" class="quickQuotehoverbutton turbo-blue" value="Address" onclick="openEngineerAddress()" style="width:90px;">
	...
	<table>
			<tr>
				<td align="right"><label>Categories : &nbsp;</label> 
					...
					<input type="checkbox" style="vertical-align: middle;display: none;" id="architectche" onclick="architect()" onChange="updateRolodex()"><label id="Category2lab" style="display: none;"></label>
					...
					<%-- <input type="checkbox" style="vertical-align: middle;" id="architectche" value="${requestScope.rxMasterDetails.isCategory1}" onclick="architect()" onChange="updateRolodex()"><label>&nbsp;Architect</label>
					<input type="checkbox" id="engineerche"	style="vertical-align: middle;" value="${requestScope.rxMasterDetails.isCategory2}" onclick="engineer()" onChange="updateRolodex()"><label>&nbsp;Engineer</label>
					<input type="checkbox" id="customerchek" style="vertical-align: middle;" onclick="customer()" onChange="updateRolodex()"><label>&nbsp;Customer</label>
					<input	type="checkbox" id="vendorcheck" style="vertical-align: middle;" onclick="vendor()" onChange="updateRolodex()"><label>&nbsp;Vendor</label>
					<input type="checkbox" id="employeeche" style="vertical-align: middle;" onclick="employee()" onChange="updateRolodex()"><label>&nbsp;Employee</label>
	 ...
	 <div id="engineerAddressGrid">
		<table>
			...
			<tr>
				<td align="right"><input type="button" class="add" id="add"	value="   Add" onclick="addAddressEngineer()">
				<input type="button" class="cancelhoverbutton turbo-blue" id="edit" value="Edit" style="width:60px" onclick="editAddressEngineer()">
				<input type="button" class="cancelhoverbutton turbo-blue" id="add"	value=" Cancel" style="width:80px" onclick="cancelAddressEngineer()"></td>
			</tr>
			<tr height="10px;"></tr>
		</table>
	</div>
	<div id="rolodexContactCustom">
	 	<form action="" id="rolodexContactCustomForm">
			<table>
				...
				<tr>
					...
					<td>
						<input type="text" id="lastName" name="lastName"  class="validate[required]" maxlength="40" style="width:240px;margin-left: 3px;">
					</td>
				</tr>
				<tr>
					<td width="100px;">
	 ...
	 <div id=addEngineerAddress>
		<form action="" id="rolodexAddressCustomForm">
		 <div id="addAddress">
			<table>
			<tr><td>
			  <fieldset style="width:350px; height:140px" class= " ui-widget-content ui-corner-all">
				...
				<tr>
					<td style=" width : 50px;">
						...
						<td>
							<input type="text" style="width: 160px;" id="cityNameID" placeholder="Minimum 2 characters required" name="locationCity" value="${requestScope.rxAddressDetails.city}">
							<img alt="search" src="./../resources/scripts/jquery-autocomplete/search.png">
							<label>State:</label>
							<input type="text" style="width: 25px;text-transform: uppercase" id="stateNameID" name="locationState" value="${requestScope.rxAddressDetails.state}" maxlength="2">
						</td>
				</tr>
				<tr>
					<td style=" width : 50px;">
						...
						<td>
							<input type="text" style="width: 100px;" id="locationZipID" class="validate[custom[number]]" name="locationZip" value="${requestScope.rxAddressDetails.zip}">
						</td>
				</tr>
			<!-- 	<tr>
					<td style="width:70px">
						<input type="checkbox" name="mailAddress" style="vertical-align:middle;" id="mailAddress"  />Mailing</td>
					<td style="width:145px">
						<input type="checkbox" style="vertical-align:middle;" id="shipAddress" name="shipAddress"  />Ship To</td>
				</tr> -->
				</table>
			 </fieldset>
			</td>
			<td style="vertical-align:top"  id="phoneField">
					<fieldset style="width:350px; height: 140px;" class= " ui-widget-content ui-corner-all">
						...
						<tr>
							...
							<td>
								<input type="text" id="areaId" name="contact1" style="width:50px" maxlength="3" value="">&nbsp;
								<input type="text" id="exchangeId" name="contact1" style="width:50px" maxlength="3" value="">&nbsp; - &nbsp;
								<input type="text" id="subscriberId" name="contact1" style="width:100px" value="">
							</td>
						</tr>
						<tr>
							<td style=" width : 50px;">
							...
							<td>
								<input type="text" id="areaId1" name="contact2" style="width:50px" maxlength="3" value="">&nbsp;
								<input type="text" id="exchangeId1" name="contact2" style="width:50px" maxlength="3" value="">&nbsp; - &nbsp;
								<input type="text" id="subscriberId1" name="contact2" style="width:100px" value="">
							</td>
						</tr>
						<tr>
							<td style=" width : 50px;">
							...
							<td>
								<input type="text" id="areaId2" name="contact3" style="width:50px" maxlength="3" value="">&nbsp;
								<input type="text" id="exchangeId2" name="contact3" style="width:50px" maxlength="3" value="">&nbsp; - &nbsp;
								<input type="text" id="subscriberId2" name="contact3" style="width:100px" value="">
							</td>
						</tr>
						</table>
					</fieldset>
			...
			<table style="align:right" >
		 	<tr>
			  <td align="right" style="padding-right:1px;">
					<input type="button" class="savehoverbutton turbo-blue" value="Save & Close" onclick="savenewEngineer()" style=" width:120px;">
					<input type="button" class="cancelhoverbutton turbo-blue"  value="Cancel" onclick="cancelAddEngineer()" style="width:80px;">  
			  </td>
			</tr>
		</table>
	</form>
...
<div id="quickQuoteDialog">
		...
		jQuery(document).ready(function() {
			...
			name = name.replace(')', ' ');
				...
				if(archTech === 'true'){
					...
					//$("#architectche").attr("disabled", "disabled");
				}
				if(Engg === 'true'){
					$("#engineerche").attr("checked", true);
					//$("#engineerche").attr("disabled", "disabled");
				}
	...
	function openEngineerAddress()
	{	
		loadAddressGrid();
		jQuery("#engineerAddressGrid").dialog("open");
	}
	
	jQuery(function(){
		jQuery("#engineerAddressGrid").dialog({
				autoOpen : false,
				modal : true,
				title:"Engineer Address",
				width: 1050,  left: 300, top: 290,
				buttons : {  },
				close:function(){
					return true;
				}
	...
	function cancelAddressEngineer(){
		$("#engineerAddressGrid").dialog("close");
		return true;
	}
		...
		function addAddressEngineer()
		{	
			aGlobalVariable = "add";
			$("#locationAddressID1").val(''); $("#locationAddressID2").val(''); $("#cityNameID").val(''); $("#stateNameID").val('');
			$("#locationZipID").val('');$("#phoneField").hide(); 
			$("#exchangeId2").val('');$("#subscriberId2").val('');$("#areaId").val(''); 
			$("#exchangeId").val('');$("#subscriberId").val('');$("#areaId1").val('');$("#shipAddress").attr("checked", false);  
			$("#exchangeId1").val('');$("#subscriberId1").val('');$("#mailAddress").attr("checked", false); 
			jQuery("#addEngineerAddress").dialog("open");
		}

		jQuery(function(){
			jQuery("#addEngineerAddress").dialog({
					autoOpen : false,
					modal : true,
		...
		function editAddressEngineer()
		{
			...
			if(fax == null || fax.length == 0){
				...
				$("#locationAddressID1").val(address1); $("#locationAddressID2").val(address2); $("#cityNameID").val(city); $("#stateNameID").val(state);
				$("#locationZipID").val(zip);
		...
		function savenewEngineer(){
			...
			$.ajax({
				url: "companycontroller/newCompanyAddress",
				type: "POST",
				async:false,
				data : engineerForm+ "&rolodexNumber="+ rolodexNumber+"&operation=" +aGlobalVariable,
				success: function(data) {
					$("#EmployeeDetailCategoriesGrid").trigger("reloadGrid");
				}
			});jQuery("#addEngineerAddress").dialog("close");
			}else if(aGlobalVariable === "edit"){
				var grid = $("#EmployeeDetailCategoriesGrid");
				var rowId = grid.jqGrid('getGridParam', 'selrow');
				...
				name1 = name1.replace(')', ' ');
				var engineerForm = $("#rolodexAddressCustomForm").serialize();
				var address=grid.jqGrid('getCell', rowId, 'address1');
				var customer="${requestScope.rxMasterDetails.isCustomer}";
				var vendor="${requestScope.rxMasterDetails.isVendor}";
				var employee="${requestScope.rxMasterDetails.isEmployee}";
				...
				$.ajax({
						...
						"&operation=" +aGlobalVariable+"&CustomerId=" +customer + "&VendorId=" +vendor + "&ArchitectId=" +architect+"&EngineerId=" +engineer+"&EmployeeId=" +employee,
						success:function(data){
							$("#EmployeeDetailCategoriesGrid").trigger("reloadGrid");
						}
					});
		...
		function cancelAddEngineer(){
			$('#rolodexAddressCustomForm').validationEngine('hideAll');
			$("#addEngineerAddress").dialog("close");
			return true;
		}
	...
	function loadAddressGrid() {
		...
		$("#EmployeeDetailCategoriesGrid").jqGrid({
			...
			mtype : 'GET',
			colNames : [ 'Address','Address2', 'City', 'State','Zip','Phone','Phone2','Fax','Mailing','Shipping' ],
			colModel : 
	...
	function loadContactsGrid() {
		...
		$("#VendorDetailsGrid").jqGrid({
			...
			[{name: 'rxContactId',index:'rxContactId',align:'left',width:50,hidden: true, editable:true,editoptions:{},editrules:{required:false,edithidden:false}},
			 {name: 'lastName',index : 'lastName',align : 'left',width : 50, editable : true,hidden : false,editoptions : {size : 30,maxlength:40,readonly : true},editrules : {edithidden : false,required : false}},
			 {name: 'firstName',index : 'firstName',align : 'left',width : 50,hidden : false,editable : true, editoptions : {size : 20,maxlength:40,readonly : false,alignText : 'right'	},editrules : {edithidden : true,required : true}},
	...
	/*function cancelAddvendor(){
		$('#rolodexAddressCustomForm').validationEngine('hideAll');
		$("#addVendorAddress").dialog("close");
		return true;
	}*/
	
	 $(function() { var cache = {}; var lastXhr=''; $( "#cityNameID" ).autocomplete({ minLength: 2,timeout :1000,
			select: function( event, ui ) { var stateSelect =	ui.item.label; var stateSplit = stateSelect.split(" ("); 
			var stateName = stateSplit[1]; var stateCode = stateName.replace(")", ""); $("#stateNameID").val(stateCode);},
