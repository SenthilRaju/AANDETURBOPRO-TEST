		...
		<table style="width:1080px;align:center">
		 	<tr>
			 	...
			 	<td id="addQuotesTemplateView" align="right" style="padding-right:1px;">
			 		<input type="button" id="quoteTemplateSaveId" class="savehoverbutton turbo-tan" value="Save & Close" onclick="saveANDcloseQuoteTemplate()" style=" width:125px;">
					<input type="button" id="quoteTemplateCancel" class="cancelhoverbutton turbo-tan"  value="Cancel" onclick="cancelQuoteTemplate()" style="width:80px;">  
				</td>
