					...
					<td style="vertical-align: top;width: 200px;">
						...
						<table>
							<tr>
								...
								<td>
								<fieldset class= " ui-widget-content ui-corner-all">
								<legend><label class="fontclass"><b>GL Accounts</b></label><span style="color: red;"> *</span></legend>
								<table>
									<tr>
														...
														<option value="0"> - Select - </option>
															<c:forEach var="accounts" items="${requestScope.accounts}">
																<option value="${accounts.coAccountId}">
																	<c:out value="${accounts.description}"></c:out> # <c:out value="${accounts.number}"></c:out>
																</option>
														</c:forEach>
												</select>
											</td>
							...
							<tr>
								...
								<td>
								<fieldset class= " ui-widget-content ui-corner-all">
								<legend><label class="fontclass"><b>Adjustment COGs</b></label><span style="color: red;"> *</span></legend>
								<table>
									<tr>
										<td><label class="fontclass">Asset:</label></td>
										<td>
											<select style="width:250px;" id="adjustcog" name="adjustcogName">
														<option value="0"> - Select - </option>
															<c:forEach var="accounts" items="${requestScope.accounts}">
																<option value="${accounts.coAccountId}">
																	<c:out value="${accounts.description}"></c:out> # <c:out value="${accounts.number}"></c:out>
