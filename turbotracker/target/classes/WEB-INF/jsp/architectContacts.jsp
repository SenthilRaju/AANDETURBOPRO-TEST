...
<div id="architectGeneral">
	<form id="architectFormID">
	<table>
		<tr height="0px;"></tr>
		<tr>
			<td width="105px;" style="padding-bottom: 10px;"><label>Customer Name: </label></td>
			 <td width="615px;" style="padding-bottom: 10px;">
				...
				<input type="button" class="savebutton" value="    "  onclick="updateArchitect()" id="saveButton">
			</td>
			<td align="right">
				<input type="button" class="quickQuotehoverbutton turbo-blue" value="Address" onclick="openArchitectAddress()" style="width:90px;"> 
	 ...
	 <div id="architectAddressGrid">
		<table>
			...
			<tr>
				<td align="right"><input type="button" class="add" id="add"	value="   Add" onclick="addAddressArchitect()">
				<input type="button" class="cancelhoverbutton turbo-blue" id="edit" value="Edit" style="width:60px" onclick="editAddressArchitect()">
				<input type="button" class="cancelhoverbutton turbo-blue" id="add"	value=" Cancel" style="width:80px" onclick="cancelAddressArchitect()"></td>
			</tr>
			<tr height="10px;"></tr>
		</table>
	</div>
			...
			<table align="right">
		 	<tr>
			  <td align="right" style="padding-right:1px;">
					<input type="button" class="savehoverbutton turbo-blue" value="Save & Close" onclick="savenewArchitect()" style=" width:120px;">
					<input type="button" class="cancelhoverbutton turbo-blue"  value="Cancel" onclick="cancelAddArchitect()" style="width:80px;">  
			  </td>
			</tr>
		</table>
	</form>
...
<div id="editQuickQuoteDialog">
	...
	function loadContactsGrid() {
		...
		$("#VendorDetailsGrid").jqGrid({
			...
			mtype: 'GET',
			colNames: [ 'RxContactId','Last', 'First', 'Role', 'Phone', 'Direct Line', 'Email', 'CellPhone', 'Division' ],
			colModel: 
	...
	function openArchitectAddress()
	{	
		loadAddressGrid();
		jQuery("#architectAddressGrid").dialog("open");
	}

	jQuery(function(){
		jQuery("#architectAddressGrid").dialog({
			autoOpen : false,
			modal : true,
			title:"Architect Address",
	...
	function cancelAddressArchitect(){
		$("#architectAddressGrid").dialog("close");
		return true;
	}

	function addAddressArchitect()
	{	
		aGlobalVariable = "add";
		...
		jQuery("#addArchitectAddress").dialog("open");
	}

	jQuery(function(){
		jQuery("#addArchitectAddress").dialog({
				autoOpen : false,
				modal : true,
	...
	function savenewArchitect(){
		...
		});jQuery("#addArchitectAddress").dialog("close");
		}else if(aGlobalVariable === "edit"){
			var grid = $("#EmployeeDetailCategoriesGrid");
			var rowId = grid.jqGrid('getGridParam', 'selrow');
	...
	function cancelAddArchitect(){
		$('#rolodexAddressCustomForm').validationEngine('hideAll');
		$("#addArchitectAddress").dialog("close");
		return true;
	}
	...
	function loadAddressGrid() {
	 ...
	 $(function() { var cache = {}, lastXhr; $( "#cityNameID" ).autocomplete({ minLength: 2,timeout :1000,
