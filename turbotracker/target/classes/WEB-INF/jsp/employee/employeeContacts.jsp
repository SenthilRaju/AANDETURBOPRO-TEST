	...
	<div id= "addNewEmployee">
		<form action="" id="addNewEmployeeForm">
			...
			<table>
				...
				<tr>
					<td align="right">
						<input type="button" id="customerQuickQuote" class="quickQuotehoverbutton turbo-blue" value="Quick Quote" onclick="openQuickQuote()" disabled style="width:120px;">
					</td>
				</tr>
				<tr>
			...
			<table>
				<tr>
					<td style="vertical-align:top">
				 		 <fieldset style="height:130px;width: 320px" class= " ui-widget-content ui-corner-all">
							<legend><label><b>Name</b></label></legend>
								<table>
										<tr>
											<td width="80px;" style="padding-bottom: 10px;"><label>Name: </label><span style="color:red;"> *</span></td>
											<td width="" style="padding-bottom: 10px;"><b><input type="text" name="EmployeeLastName" size="25" tabindex="1" class="validate[required] validate[maxSize[40]]" value="${requestScope.rxMasterDetails.name}" id="EmployeeLastName"  /></b></td>
										</tr>
										<tr>
											<td width="80px;" style="padding-bottom: 10px;"><label>First Name: </label></td>
											<td width="" style="padding-bottom: 10px;"><b>
											<input type="text" name="EmployeeName" size="25" tabindex="1" class="validate[maxSize[25]]" value="${requestScope.rxMasterDetails.firstName}" id="EmployeeName"  /></b></td>
										</tr>
										<tr >
										<td style="width : 80px">
					...
					<td style="vertical-align:top">
					<input type="hidden" id="rxAddressId" name="rxAddressId" value="${requestScope.rxAddressDetails.rxAddressId}">
					 	 <fieldset style="height:130px; width:355px" class= "ui-widget-content ui-corner-all">
							<legend><label><b>Address</b></label></legend>
							<table>
							<tr>
									<td style="width: 50px"><label>Address: </label></td>
								<td>
									<input type="text" style="width:245px;" id="locationAddress1" name="locationAddress1" value="${requestScope.rxAddressDetails.address1}">
								</td>
							</tr>
							<tr>
								<td style="width: 50px"><label></label></td>
								<td>
									<input type="text" style="width: 245px;" id="locationAddress2" name="locationAddress2" value="${requestScope.rxAddressDetails.address2}">
								</td>
							</tr>
							<tr>
								<td style="width : 60px">
								...
								<td >
									<input type="text" style="width: 133px;" id="locationCity" placeholder="Minimum 2 characters required" name="locationCity" value="${requestScope.rxAddressDetails.city}">
									<img alt="search" src="./../resources/scripts/jquery-autocomplete/search.png" >
									<label> &nbsp;State:&nbsp;   </label>
									<input type="text" style="width: 20px;text-transform: uppercase" id="locationState" name="locationState" value="${requestScope.rxAddressDetails.state}" maxlength="2">
								</td>
							</tr>
							<tr>
								<td style="width: 50px">
								...
								<td>
									<input type="text" style="width: 133px;" id="locationZip" class="validate[maxSize[10]]" name="locationZip" value="${requestScope.rxAddressDetails.zip}">
								</td>
							</tr>
						</table>
				 	</fieldset>
				...
				<td style="vertical-align:top">
				<fieldset style=" height: 130px;width: 340px;"class= " ui-widget-content ui-corner-all">
					...
					<tr>
						...
						<td>
							<input type="text" id="areaCode" name="contact1" class="validation[custom[onlyNumber]]" style="width:50px" maxlength="3" value="">
							<input type="text" id="exchangeCode" name="contact1" class="validation[custom[onlyNumber]]" style="width:50px" maxlength="3" value=""> -
							<input type="text" id="subscriberNumber" name="contact1" class="validation[custom[onlyNumber]]" style="width:90px" value="">
						</td>
					</tr>
					<tr>
						<td style="width : 70px">
						...
						<td>
							<input type="text" id="areaCode1" name="contact2" class="validation[custom[onlyNumber]]" style="width:50px" maxlength="3" value="">
							<input type="text" id="exchangeCode1" name="contact2" class="validation[custom[onlyNumber]]" style="width:50px" maxlength="3" value=""> - 
							<input type="text" id="subscriberNumber1" name="contact2" class="validation[custom[onlyNumber]]" style="width:90px" value="">
						</td>
					</tr>
					<tr>
						<td style="width : 70px">
						...
						<td>
							<input type="text" id="areaCode2" name="contact3" class="validation[custom[onlyNumber]]" style="width:50px" maxlength="3" value=""  onkeyup="autoFocusCell(this)">
							<input type="text" id="exchangeCode2" name="contact3" class="validation[custom[onlyNumber]]" style="width:50px" maxlength="3" value=""  onkeyup="autoFocusCellNext(this)"> - 
							<input type="text" id="subscriberNumber2" name="contact3" class="validation[custom[onlyNumber]]" style="width:90px" value="">
						</td>
					</tr>
					<tr>
						<td style="width:70px">
						...
						<td>
							<input type="text" id="officeExtensionId" name="officeExtension" class="validate[custom[number]]" value="${requestScope.rxMasterDetails.phone3}">
						</td>
					</tr>
				</table>
			</fieldset>
 	...
 	<table>
		...
		<tr>
			<td align="right">
				<input type="button" class="add" id="add"	value="   Add" onclick="addEngineerContacts()">
				<input type="button" class="cancelhoverbutton turbo-blue" id="add"	value=" Edit " style="width:60px" onclick="editEngineerContacts()">
  	...
  	<table>
		<tr>
			<td align="right">
				...
				<input type="checkbox" id="engineerche" style="vertical-align: middle;display: none;" onclick="engineer()" onChange="updateRolodex()"><label id="Category1lab" style="display: none;"></label>
				<input type="checkbox" id="architectche" style="vertical-align: middle;display: none;" onclick="architect()" onChange="updateRolodex()"><label id="Category2lab" style="display: none;"></label>
				<input type="checkbox" id="caustMGR" name="caustMGR" style="vertical-align: middle;display: none;" onChange="updateRolodex()"><label id="Category3lab" style="display: none;"></label>
				<input type="checkbox" id="owner" name="owner" style="vertical-align: middle;display: none;" onChange="updateRolodex()"><label id="Category4lab" style="display: none;"></label>
				<input type="checkbox" id="bondAgent" name="bondAgent" style="vertical-align: middle;display: none;" onChange="updateRolodex()"><label id="Category5lab" style="display: none;"></label>
				<input type="checkbox" id="Category6Desc" name="Category6Desc" style="vertical-align: middle;display: none;" onChange="updateRolodex()"><label id="Category6lab" style="display: none;"></label>
				<input type="checkbox" id="Category7Desc" name="Category7Desc" style="vertical-align: middle;display: none;" onChange="updateRolodex()"><label id="Category7lab" style="display: none;"></label>
				<input type="checkbox" id="Category8Desc" name="Category8Desc" style="vertical-align: middle;display: none;" onChange="updateRolodex()"><label id="Category8lab" style="display: none;"></label>
			</td>
		</tr>
	</table> 
...
<!-- 	<table>
		...
		<tr>
			<td align="left"><input type="checkbox" id="multimail" style="vertical-align: middle;">
			<label>&nbsp;Mailing Address</label></td>
			<td align="right"><input type="button" class="add" id="add" value="Add"></td>
		</tr>
	...
	<div style="height: 70px;">
				<table style="width: 1105px">
					...
					<tr>
						<td align="right"><input type="button" class="savehoverbutton turbo-blue" value="Save"id="mainsave" onclick="savenewEngineerAddress()" style="width: 80px">
															<input type="button" class="savehoverbutton turbo-blue" value="Delete Employee" id="deleteEmployeeID" onclick="deleteEmployee()" style="width: 130px"></td>
					</tr>
				</table>
		</div>
</div>
<div id="engineerContactCustom">
	 	<form action="" id="engineerContactCustomForm">
			<table>
				<tr id="ContactIDTD">
					<td width="100px;">
				...
				<tr>
					...
					<td>
						&nbsp;<input type="text" id="areaCode1" name="contact2" style="width:50px" class="validation[custom[onlyNumber]]" maxlength="3" value="">&nbsp;
						<input type="text" id="exchangeCode1" name="contact2" style="width:50px" class="validation[custom[onlyNumber]]" maxlength="3" value=""> - 
						<input type="text" id="subscriber1" name="contact2" style="width:90px" class="validation[custom[onlyNumber]]" maxlength="4" value="">
					</td>
				</tr>
				<tr>
					<td style=" width : 100px;">
	...
	<div id="addProductDialog" align="left">
		...
		<table id="addquotesList"><div id="addquotespager"></div></table>
		<table align="right" style="padding-right: 20px;">
			<tr>
			<td id="QuoteId" ><label>HeaderID: </label><input type="hidden" id="joQuoteHeaderID" style="width:100px"></td>
	...
	jQuery(document).ready(function() {
		var aActive="${requestScope.rxMasterDetails.inActive}";
		if(aActive === 'true') {
			$('#InactiveCheckID').attr('checked','checked');
		}
		var phone1="${requestScope.rxMasterDetails.phone1}";
		var phone2="${requestScope.rxMasterDetails.phone2}";
		var fax="${requestScope.rxMasterDetails.fax}";
		if(phone1 === null || phone1.length === 0){
			if(phone2 === null || phone2.length === 0){
				if(fax === null || fax.length === 0){}else
						{	var areacode2 = fax.split(" ");
						var exchangecode2;
						if(areacode2[1]!=null && areacode2[1]!=undefined){
							...
							var exchangecode1;
							if(areacode1[1]!=null && areacode1[1]!=undefined){
						...
						var exchangecode;
						if(areacode[1]!=null && areacode[1]!=undefined){
	...
	function savenewEngineerAddress(){
		...
		var name1="${requestScope.rxMasterDetails.name}";
		var engineerForm = $("#addNewEmployeeForm").serialize();
		var address="${requestScope.rxAddressDetails.address1}";
		var searchName="${requestScope.rxMasterDetails.searchName}";
		var customer="${requestScope.rxMasterDetails.isCustomer}";
		var vendor="${requestScope.rxMasterDetails.isVendor}";
		var isEmployee="${requestScope.rxMasterDetails.isEmployee}";
		var architect="${requestScope.rxMasterDetails.isCategory1}";
		var engineer="${requestScope.rxMasterDetails.isCategory2}";
		var datasend = engineerForm+ "&USPhoneNumber="+ contact1 +"&USPhone_Number="+ contact2 +"&fax=" +fax +"&rolodexNumber="+ rolodexNumber+"&existingAddress1="+ address +"&Name=" +name1+ "&EmployeeId=" +isEmployee +"&searchName=" +searchName
		...
		$.ajax({
				type:'POST',
				url: "customerList/newEmployeeAddress",
	...
	function loadContactsGrid() {
		...
		$("#EmployeeDetailsGrid").jqGrid({
			...
			postData: {'rolodexNumber' : rolodexNumber },
			mtype: 'GET',
			colNames: [ 'RxContactId','Last Name', 'First Name', 'Role', 'Phone', 'Direct Line','Extension', 'Email', 'CellPhone', 'Division' ],
			colModel: 
	...
	$(function() {var cache = {}; var lastXhr=''; $("#customerID").autocomplete({ minLength: 2,timeout :1000,select: function( event, ui ) 
		...
		function deleteEmployee(){
			...
			if(aSysAdmin !== '1'){
				var info = "You are not authorized to perform this action.  Please contact your System Administrator.";
				...
				var aEmployeeID = getUrlVars()["rolodexNumber"];
				var newDialogDiv = jQuery(document.createElement('div'));
				  jQuery(newDialogDiv).html('<span><b style="color: red;">Delete this Employee Record?</b></span>');
				  jQuery(newDialogDiv).dialog({modal: true, width:300, height:120, title:"Confirm Delete", 
				 buttons:{
					"Submit": function(){
						jQuery(this).dialog("close");
						...
						$.ajax({
							type:'POST',
							url: "./employeeCrud/deleteEmployeeDetail",
							data: {'employeeID' : aEmployeeID },
							success:function(data){
								createtpusage('Company-Employee','Delete Employee','Info','Company-Employee,Deleting Employee,EmployeeId:'+aEmployeeID);
								$('#loadingMainDiv').css({"visibility": "hidden"});
								jQuery(newDialogDiv).attr("id","msgDlg");
								jQuery(newDialogDiv).html('<span><b style="color:green;">Employee is Deleted Sucessfully.</b></span>');
								jQuery(newDialogDiv).dialog({modal: true, width:300, height:150, title:"Message",
									buttons: [{height:35,text: "OK",click: function() {  $(this).dialog("close");  document.location.href = "./employeelist";}}]}).dialog("open");
								return true;
							}
					  });
					},
