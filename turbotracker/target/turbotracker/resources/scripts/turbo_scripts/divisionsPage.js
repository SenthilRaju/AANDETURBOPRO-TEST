...
function loadDivisions(){
	$("#divisionsGrid").jqGrid({
		...
		caption: 'Divisions',
		height:503,	width: 350,/*scrollOffset:0,*/rownumbers:true,rownumWidth:34,
	    jsonReader : {
            root: "rows",
            page: "page",
            total: "total",
...
function saveNewDivisions(){
	...
	var description = $.trim($("#newCoDivisionNameID").val());
	var address1 = $.trim($("#newAddressID1").val());
	var address2 = $.trim($("#newAddressID2").val());
	var address3 = $.trim($("#newAddressID3").val());
	var address4 = $.trim($("#newAddressID4").val());
	if(description === null || description === ""){
		$("#newDescriptionWarning").show();
		$("#newAddressWarning").hide();
		return false;
		}
	if( address1 === "" && address2 === "" && address3 === "" && address4 === ""){
		$("#newAddressWarning").show();
		$("#newDescriptionWarning").hide();
		return false;
	}
	$.ajax({
