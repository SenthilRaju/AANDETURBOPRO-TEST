...
function loadContactsGrid() {
	...
	$("#EmployeeDetailsGrid").jqGrid({
		...
		colNames: ['RxContactId', 'RxMasterId', 'Last Name', 'First Name', 'Role', 'Direct Line','Email', 'Cell'],
		colModel:
		[{name:'rxContactId',index:'rxContactId',align:'left',width:50, hidden: true, editable:true,editoptions:{},editrules:{required:false,edithidden:false}},
		 ...
		 {name:'lastName',index:'lastName',align:'left',width:50, editable:true,editoptions:{size:30},editrules:{required:true}},
		 {name:'firstName',index:'firstName',align:'left',width:30,editable:true,editoptions:{size:30},editrules:{required:true}},
...
function savenewcustomerAddress(){
	...
	$.ajax({
			...
			+ "&CustomerId=" +customer + "&VendorId=" +vendor + "&ArchitectId=" +architect+"&EngineerId=" +engineer+"&aEmployeeActive=" +aActive+"&isMailing=" +isMailing +"&isShipping=" +isShipping,
			success:function(data){
