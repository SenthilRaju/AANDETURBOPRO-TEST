		...
		<div id="turbo_app_home" style="height: 100px;">
			<div id="turbo_app_header">
				<div class="app_logo">
					...
					<label style="color:#003765;font-size:14px;font-family: Myriad Pro,Arial,Helvetica,Tahoma,sans-serif;font-style:italic;
							background:#D8D7D8;padding:3px 10px;vertical-align:top;border-bottom-right-radius:5px;border-bottom-left-radius:5px;">
					Version 2.0.3</label>
				</div>
					...
					<div class="app_main_navi">
						<ul>
							...
							<li id="mainmenuBankingPage"><a class="report" href="#" onclick="">Reports</a>
								...
								<li><a href="" onclick="openPOCriteriaPage()">Open PO</a></li></ul>
							</li>
						</ul>
					</div>
				</div>
		...
		<div align="center" style="padding-top: 10px;" id="search">
			<table>
				<tr>
					...
					<td> 
						<input type="button" class="go turbo-blue" value="Go">  <!-- onclick="getSearchDetails()"-->
					</td>
					<td>
