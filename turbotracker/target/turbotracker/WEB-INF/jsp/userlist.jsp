...
<jsp:include page="addNewUser.jsp"></jsp:include>
	...
	function loadUserList(aActiveUser){
		...
		$("#userlist").jqGrid({
			...
			colNames:['User Id', 'Login Name', 'Full Name', 'Initials', 'Email Address', 'Active', 'Admin'],
		   	colModel:[
				...
				{name:'fullName',index:'fullName',align:'left', width:250,editable:true, editrules:{required:true}, editoptions:{size:10}},
