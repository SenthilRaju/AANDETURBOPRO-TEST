				...
				<fieldset class=" ui-widget-content ui-corner-all">
					...
					<table>
						<tr>
							...
							<td>&nbsp;
								<input type="text" id="engineer_salesRepsList" name="salesReps" style="width: 200px;" placeholder="Minimum 2 characters required" value="${requestScope.AssignedSalesRep}">
							</td>
						...
						<tr>
							...
							<td>&nbsp; 
								<input type="text" id="engineer_CSRList" name="CSRListRep" style="width: 200px;" value="${requestScope.AssignedCSRs}" placeholder="Minimum 2 characters required">
							</td>
							<td><img alt="search" src="./../resources/scripts/jquery-autocomplete/search.png"></td>
						...
						<tr>
							...
							<td>&nbsp; 
								<input type="text" id="engineer_SalesMgrList" name="SalesMgrList" style="width: 200px;" value="${requestScope.AssignedSalesMGRs}" placeholder="Minimum 2 characters required">
							</td>
							<td><img alt="search" src="./../resources/scripts/jquery-autocomplete/search.png"></td>
						...
						<tr>
							...
							<td>&nbsp; 
									<input type="text" id="engineer_EngineersList" name="EngineersList" style="width: 200px;" value="${requestScope.AssignedEngineers}" placeholder="Minimum 2 characters required">
							</td>
							<td><img alt="search" src="./../resources/scripts/jquery-autocomplete/search.png"></td>
						...
						<tr>
							...
							<td>&nbsp; 
									<input type="text" id="engineer_PrjMgrList" name="PrjMgrList" style="width: 200px;" value="${requestScope.AssignedProjManagers}" placeholder="Minimum 2 characters required">
							</td>
							<td><img alt="search" src="./../resources/scripts/jquery-autocomplete/search.png"></td>
