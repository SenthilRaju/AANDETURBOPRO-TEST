					...
					<td style="vertical-align:top">
					 	 <fieldset style="height:130px; width:355px" class= "ui-widget-content ui-corner-all">
							...
							<tr>
								...
								<td>
									<input type="text" style="width: 100px;" id="locationZip" class="validate[custom[number]]" name="locationZip" value="${requestScope.rxAddressDetails.zip}">
								</td>
							</tr>
						</table>
				 	</fieldset>
  	...
  	<table>
		<tr>
			<td align="right">
				...
				<input type="checkbox" id="architectche" style="vertical-align: middle;" onclick="architect()" onChange="updateRolodex()"><label>&nbsp;Architect</label>
				...
				<input type="checkbox" id="bondAgent" name="bondAgent" style="vertical-align: middle;" onChange="updateRolodex()"><label>&nbsp;Bond Agent</label></td>
		</tr>
	</table> 
	...
	$(function() {var cache = {}; var lastXhr=''; $("#customerID").autocomplete({ minLength: 2,timeout :1000,select: function( event, ui ) 
		...
		function viewJobPage(){
			...
			if(rowIdQuote === null){
				...
				var aQryStr = "jobNumber="+aJobNumber+"&jobName="+aJobName+"&jobCustomer="+aJobCustomer+"&jobStatus="+aJobStatus;
