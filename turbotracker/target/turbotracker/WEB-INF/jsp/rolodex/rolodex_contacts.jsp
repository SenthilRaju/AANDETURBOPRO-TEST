	...
	<form id="rolodexdfromID">
	 ...
	 <div id="rolodexAddressGrid">
		<table>
			...
			<tr>
				<td align="right"><input type="button" class="add" id="add"	value="   Add" onclick="addAddressRolodex()">
				<input type="button" class="cancelhoverbutton turbo-blue" id="edit" value="Edit" style="width:60px" onclick="editAddressRolodex()">
				<input type="button" class="cancelhoverbutton turbo-blue" id="add"	value=" Cancel" style="width:80px" onclick="cancelAddressRolodex()"></td>
			</tr>
			<tr height="10px;"></tr>
		</table>
	</div>
			...
			<table align="right">
		 	<tr>
			  <td align="right" style="padding-right:1px;">
					...
					<input type="button" class="cancelhoverbutton turbo-blue"  value="Cancel" onclick="cancelAddRolodex()" style="width:80px;">  
			  </td>
			</tr>
		</table>
	</form>
...
<div id="quickQuoteDialog">
	...
	{	
		loadAddressGrid();
		jQuery("#rolodexAddressGrid").dialog("open");
	}
	
	jQuery(function(){
		jQuery("#rolodexAddressGrid").dialog({
				autoOpen : false,
				modal : true,
	...
	function cancelAddressRolodex(){
		$("#rolodexAddressGrid").dialog("close");
		return true;
	}

	function addAddressRolodex()
	{	
		aGlobalVariable = "add";
