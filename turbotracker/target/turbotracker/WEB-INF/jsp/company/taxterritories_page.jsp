																...
																<fieldset  class= " ui-widget-content ui-corner-all" style="margin-left: 5px;">
																	...
																	<table>
																		<tr>
																			...
																			<td><input type="text" name="stateName" id="stateID" style="width:50px"  value=""></td>
																			<td><label style="vertical-align: middle;">code: </label></td>
																			<td><input type="text" name="CountyCodeName" id="CountyCodeId" style="width:50px"  value=""></td>
																		</tr>
																		<tr>
				...
				<fieldset  class= " ui-widget-content ui-corner-all" style="margin-left: 5px;">
					...
					<table>
						<tr>
							...
							<td><input type="text" name="stateName" id="stateID" style="width:50px"  value=""></td>
							<td><label style="vertical-align: middle;">code: </label></td>
							<td><input type="text" name="stateCodeName" id="stateCodeID" style="width:50px"  value=""></td>
						</tr>
						<tr>
							<td><label>Description: </label></td>
