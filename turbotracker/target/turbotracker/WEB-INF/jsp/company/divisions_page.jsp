				...
				<tr>
					...
					<td style="vertical-align:top;">
						<div id="divisionsDetailsTab">
							<div class="division_tabs_main" style="padding: 0px;width:800px;margin:0 auto; background-color: #FAFAFA;height: 620px;">
								<ul>
																...
																<fieldset  class= " ui-widget-content ui-corner-all" style="margin-left: 5px;">
																	...
																	<table>
																		<tr>
																			...
																			<tr><td><label>Code: </label></td><td><input type="text" name="coDivisionCode" id="CoDivisionCodeID" >
																		...
																		<tr>
																			<td><label>GL Sub Account </label></td>
																			<td><input type="text" name="subAccountName" id="subAccountID"></td>
																		</tr>
																			<tr>
