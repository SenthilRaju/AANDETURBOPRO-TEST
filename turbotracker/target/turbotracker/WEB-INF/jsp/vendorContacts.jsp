...
<div id="vendorGeneral">
	...
	<table>
		...
		<tr>
			...
			<td align="right">
				<input type="button" class="quickQuotehoverbutton turbo-blue" value="Address" onclick="openVendorAddress()" style="width:90px;"> 
			  ...
			  <fieldset style="width:350px; height:140px" class= " ui-widget-content ui-corner-all">
				...
				<tr>
					<td style=" width : 50px;">
						...
						<td>
							<input type="text" style="width: 160px;" id="cityNameID" name="locationCity" value="${requestScope.rxAddressDetails.city}">
			...
			<table style="align:right" >
		 	<tr>
			  <td align="right" style="padding-right:1px;">
					...
					<input type="button" class="cancelhoverbutton turbo-blue"  value="Cancel" onclick="cancelAddvendor()" style="width:80px;">  
			  </td>
			</tr>
		</table>
	</form>
