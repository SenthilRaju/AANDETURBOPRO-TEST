							...
							<fieldset class=" ui-widget-content ui-corner-all" style="width: 480px;">
								...
								<table>
									<tr>
										...
										<td>&nbsp;<input type="text" id="customer_salesRepsList" name="assignedSalesRep" style="width: 290px;" value="${requestScope.customerTabFormDataBean.assignedSalesRep}" title="" placeholder="Minimum 2 characters required"></td>
										<td><img alt="search" src="./../resources/scripts/jquery-autocomplete/search.png"></td>
									...
									<tr>
										...
										<td>&nbsp;<input type="text" id="customer_CSRList" name="assignedCSR" style="width: 290px;" value="${requestScope.customerTabFormDataBean.assignedCSRs}" title="" placeholder="Minimum 2 characters required"></td>
										<td><img alt="search" src="./../resources/scripts/jquery-autocomplete/search.png"></td>
									...
									<tr>
										...
										<td>&nbsp;<input type="text" id="customer_SalesMgrList" name="assignedSalesMgr" style="width: 290px;" value="${requestScope.customerTabFormDataBean.assignedSalesMGRs}" title="" placeholder="Minimum 2 characters required"></td>
										<td><img alt="search" src="./../resources/scripts/jquery-autocomplete/search.png"></td>
									...
									<tr>
										...
										<td>&nbsp;<input type="text" id="customer_EngineersList" name="assignedEngineer" style="width: 290px;" value="${requestScope.customerTabFormDataBean.assignedEngineers}" title="" placeholder="Minimum 2 characters required"></td>
										<td><img alt="search" src="./../resources/scripts/jquery-autocomplete/search.png"></td>
									...
									<tr>
										...
										<td>&nbsp;<input type="text" id="customer_PrjMgrList" name="assignedPrjMgr" style="width: 290px;" value="${requestScope.customerTabFormDataBean.assignedProjManagers}" title="" placeholder="Minimum 2 characters required"></td>
										<td><img alt="search" src="./../resources/scripts/jquery-autocomplete/search.png"></td>
						...
						<td>
							<fieldset class=" ui-widget-content ui-corner-all" style="width: 250px;">
								...
								<table>
									...
									<tr><td><label id="thisYear">:</label></td><td>$0.00</td></tr>
...
<script type="text/javascript">
	...
	function parseModelMap(){
		...
		if (invoiceMethod === "1") {
			...
			$('#invoiceMethodText').show();
			$('#invoiceMethodText').val("${requestScope.customerMasterObj.imText}");
			$("input:radio[name='invoiceMethod']:nth(1)").attr("checked", true);
		}
		...
		if (statementMethod === "1") {
			...
			$('#statementMethodText').show();
			$('#statementMethodText').val("${requestScope.customerMasterObj.smText}");
			$("input:radio[name='statementMethod']:nth(1)").attr("checked", true);
		}
	}
