...
<script type="text/javascript">
	jq(function() {
		jq("#grid").jqGrid({
			...
			datatype: 'json',
			mtype: 'GET',
		   	colNames:['Name', 'Phone', 'City', 'State'],
		   	colModel:[
		   		{name:'Name',index:'Name', width:55,editable:false,editoptions:{readonly:true,size:10},hidden:true},
		   		{name:'Phone',index:'Phone', width:100,editable:true, editrules:{required:true}, editoptions:{size:10}},
